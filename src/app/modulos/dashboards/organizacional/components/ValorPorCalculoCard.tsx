  ...
  return (
    <div className="flex-1 bg-white rounded-lg h-[489px] border border-neutral-700 relative overflow-hidden">
      ...
      <div className="flex justify-between items-center pt-[14px] px-5">
        <div title="Valor Por Tipo de Cálculo e Evento" className={`flex-grow overflow-hidden mr-3 text-black text-xl font-semibold leading-normal ${cairoClassName} whitespace-nowrap text-ellipsis`}>Valor Por Tipo de Cálculo e Evento</div>
